...
metadata (can be changed later): zeel
continue (y/n): y
...
metadata: zeel supply: 10000 warp: false
balance: 10000 27grFs9vE2YP9kwLM5hQJGLDvqEY9ii71zzdoRHNGC4Appavug
```

#### Step 4: Create an Order
So, we have some of our token (`zeel`)...now what? Let's put an order
